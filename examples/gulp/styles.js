...
module.exports = function(options) {
  gulp.task('styles', function () {
    ...
    var excludesFromImport = options.excludes && options.excludes.stylesFromImport ? options.excludes.stylesFromImport : []

    console.log('excludesFromImport', excludesFromImport);
    injectFiles = injectFiles.concat( excludesFromImport.map(function(excludeFromImport){
      return "!" + excludeFromImport;
    }));

    console.log('injectFiles', injectFiles);
